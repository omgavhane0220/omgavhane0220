...
PandhariPath — Offline-first PWA built with Team Varivision for Pandharpur Wari pilgrims: camp directories, palkhi tracking, and AI-powered guidance. Built for Varithon 2026 / Inceptia.
SCT_WD Series — Web development task series including a full TO-DO web application.
Codveda-basic--Task1- — A basic static multi-page website with homepage, about, and contact pages.
<br/>
🛠️ Tech Stack
